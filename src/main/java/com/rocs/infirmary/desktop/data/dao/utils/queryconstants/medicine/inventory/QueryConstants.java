...
public class QueryConstants {
    ...
    private final  String LIST_ALL_MEDICINE_INVENTORY_QUERY  = "SELECT i.INVENTORY_ID, i.MEDICINE_ID, i.ITEM_TYPE, i.QUANTITY_AVAILABLE, i.DESCRIPTION, m.EXPIRATION_DATE " +
            "FROM INVENTORY i " +
